...
echo:       ______________________________________________________________
echo:                                                            
echo:             [1] HWIDA Spoof Product In MS Server
echo:             [2] KMS38
echo:             [3] Online KMS
echo:             
echo:             [4] HWIDA  ^(Windows^) ^+ Online KMS ^(Office^)
...
if %_erl%==4 (set "_oem=HWIDA [Windows] + Online KMS [Office]" & set "para=/HWID /KMS-ActAndRenewalTask /KMS-Office" &goto:Extract$OEM$3)
...
if %_erl%==1 (set "_oem=HWIDA Spoof Product In MS Server" & set "para=/HWID" &goto:Extract$OEM$3)
goto :Extract$OEM$2
